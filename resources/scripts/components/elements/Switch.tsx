...
const ToggleContainer = styled.div`
    ...
    & > input[type='checkbox'] {
        ...
        &:checked + label {
            ${tw`bg-green-500 border-green-600 shadow-none`};
    ...
    & > label {
        ${tw`mb-0 block overflow-hidden cursor-pointer bg-neutral-700 border border-neutral-800 rounded-full h-6 shadow-inner`};
