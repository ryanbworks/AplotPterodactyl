        ...
        <Fade in={render} timeout={150} appear={appear || true} unmountOnExit onExited={() => onDismissed()}>
            ...
            >
                <ModalContainer alignTop={top}>
                    ...
                    <div
                        className={'p-3 sm:p-4 md:p-6 rounded-2xl shadow-2xl overflow-y-auto transition-all duration-300 border border-zinc-800/50 bg-zinc-950/40 backdrop-blur-xl'}
                    >
                        {children}
                    </div>
                </ModalContainer>
