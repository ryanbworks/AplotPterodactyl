...
const Select = styled.select<Props>`
    ${tw`shadow-none block p-3 pr-8 rounded-xl border w-full text-sm transition-all duration-150`};
    ...
    ${(props) =>
        ...
        css`
            ${tw`bg-[#050505] border-zinc-800 text-zinc-200`};
            ...
            &:focus {
                ${tw`border-green-500/50 ring-1 ring-green-500/50`};
            }
        `};
